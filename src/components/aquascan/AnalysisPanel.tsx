...
export function AnalysisPanel({
  ...
  return (
    <motion.aside
      ...
      className="pointer-events-auto mr-20 flex h-[70vh] w-[480px] flex-col overflow-hidden rounded-3xl border border-white/10 bg-slate-950/75 backdrop-blur-xl shadow-[0_0_20px_-5px_rgba(34,211,238,0.15),0_8px_32px_rgba(0,0,0,0.5)]"
      {...stopMapPropagation}
    >
      {/* === STICKY HEADER === */}
      ...
      {/* === STICKY FOOTER === */}
      <footer className="shrink-0 rounded-b-2xl border-t border-white/10 bg-slate-950 px-5 py-4">
        <SimulatorButton
